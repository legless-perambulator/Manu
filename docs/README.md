...
| [AGENT_BUILDER.md](AGENT_BUILDER.md)               | The Studio: writer-built custom agents and skill flows.         |
...
| [RESEARCH.md](RESEARCH.md)                         | Sourced real-world knowledge, kept apart from canon.            |
