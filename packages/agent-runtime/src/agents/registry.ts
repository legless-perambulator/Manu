...
export const AGENTS: readonly AgentDefinition[] = [
  {
    ...
    tools: [
      ...
      "list_branches",
      "compare_branches",
      // Phase 32: the architect operates on structured chapter plans, not on
      // prose advice. Plans are drafts for the writer; approval has no tool.
      "inspect_scene_plan",
      "validate_scene_plan",
      "create_scene_plan",
      "revise_scene_plan",
    ],
    permissions: [...READ_ONLY, "edit_plans"],
  ...
  },
  {
    ...
    tools: [
      ...
      "read_range",
      "search_project",
      // Phase 32: scene plans are the director's actual output shape.
      "inspect_scene_plan",
      "validate_scene_plan",
      "create_scene_plan",
      "revise_scene_plan",
